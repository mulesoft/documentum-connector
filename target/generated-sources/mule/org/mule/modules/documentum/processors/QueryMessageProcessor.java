...
/**
 * QueryMessageProcessor invokes the {@link org.mule.modules.documentum.DocumentumConnector#query(java.lang.String)} method in {@link DocumentumConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    protected Object dqlStatement;
    protected String _dqlStatementType;
     ...
     */
    public void setDqlStatement(Object value) {
        this.dqlStatement = value;
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedDqlStatement = ((String) evaluateAndTransform(getMuleContext(), event, QueryMessageProcessor.class.getDeclaredField("_dqlStatementType").getGenericType(), null, dqlStatement));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((DocumentumConnector) object).query(_transformedDqlStatement);
                }
    ...
    public Result<MetaData> getOutputMetaData(MetaData inputMetadata) {
        MetaDataModel metaDataPayload = getPojoOrSimpleModel(QueryResult.class);
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at DocumentumConnector at query retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
