...
/**
 * UpdateAclMessageProcessor invokes the {@link org.mule.modules.documentum.DocumentumConnector#updateAcl(java.lang.String, java.lang.String, java.util.List, com.emc.documentum.fs.datamodel.core.acl.AclVisibility, com.emc.documentum.fs.datamodel.core.acl.AclType)} method in {@link DocumentumConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public UpdateAclMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at DocumentumConnector at updateAcl retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
