...
/**
 * GetObjectMessageProcessor invokes the {@link org.mule.modules.documentum.DocumentumConnector#getObject(com.emc.documentum.fs.datamodel.core.ObjectIdentity, java.lang.String, com.emc.documentum.fs.datamodel.core.content.ContentTransferMode)} method in {@link DocumentumConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    protected Object outputPath;
    protected String _outputPathType;
     ...
     */
    public void setOutputPath(Object value) {
        ...
        throws Exception
    {
        ...
        try {
            ...
            final ObjectIdentity _transformedObjectIdentity = ((ObjectIdentity) evaluateTransformForPayload(getMuleContext(), event, GetObjectMessageProcessor.class.getDeclaredField("_objectIdentityType").getGenericType(), null, objectIdentity));
            final String _transformedOutputPath = ((String) evaluateAndTransform(getMuleContext(), event, GetObjectMessageProcessor.class.getDeclaredField("_outputPathType").getGenericType(), null, outputPath));
            final ContentTransferMode _transformedTransferMode = ((ContentTransferMode) evaluateAndTransform(getMuleContext(), event, GetObjectMessageProcessor.class.getDeclaredField("_transferModeType").getGenericType(), null, transferMode));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((DocumentumConnector) object).getObject(_transformedObjectIdentity, _transformedOutputPath, _transformedTransferMode);
                }
    ...
    public Result<MetaData> getOutputMetaData(MetaData inputMetadata) {
        MetaDataModel metaDataPayload = getPojoOrSimpleModel(File.class);
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at DocumentumConnector at getObject retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
