...
public class PropertySetExpressionHolderTransformer
    ...
    implements DiscoverableTransformer, MessageTransformer
{
    ...
    public boolean isSourceTypeSupported(Class<?> aClass) {
        return (aClass == PropertySetExpressionHolder.class);
    }

    public boolean isSourceDataTypeSupported(DataType<?> dataType) {
        return (dataType.getType() == PropertySetExpressionHolder.class);
    }

    public List<Class<?>> getSourceTypes() {
        return Arrays.asList(new Class<?> [] {PropertySetExpressionHolder.class });
    }

    public List<DataType<?>> getSourceDataTypes() {
        return Arrays.asList(new DataType<?> [] {DataTypeFactory.create(PropertySetExpressionHolder.class)});
    }
    ...
    public DataType<?> getReturnDataType() {
        return DataTypeFactory.create(PropertySet.class);
    }
        ...
        throws TransformerMessagingException
    {
        ...
        PropertySetExpressionHolder holder = ((PropertySetExpressionHolder) src);
        PropertySet result = new PropertySet();
        try {
            final Boolean _transformedIsInternal = ((Boolean) evaluateAndTransform(this.muleContext, event, PropertySetExpressionHolder.class.getDeclaredField("_isInternalType").getGenericType(), null, holder.getIsInternal()));
            result.setIsInternal(_transformedIsInternal);
