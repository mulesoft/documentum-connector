...
/**
 * DeleteObjectMessageProcessor invokes the {@link org.mule.modules.documentum.DocumentumConnector#deleteObject(com.emc.documentum.fs.datamodel.core.ObjectIdentity)} method in {@link DocumentumConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
        ...
        throws Exception
    {
        ...
        try {
            ...
            final ObjectIdentity _transformedObjectIdentity = ((ObjectIdentity) evaluateTransformForPayload(getMuleContext(), event, DeleteObjectMessageProcessor.class.getDeclaredField("_objectIdentityType").getGenericType(), null, objectIdentity));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((DocumentumConnector) object).deleteObject(_transformedObjectIdentity);
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at DocumentumConnector at deleteObject retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
