...
public class ObjectPathExpressionHolderTransformer
    ...
    implements DiscoverableTransformer, MessageTransformer
{
    ...
    public boolean isSourceTypeSupported(Class<?> aClass) {
        return (aClass == ObjectPathExpressionHolder.class);
    }

    public boolean isSourceDataTypeSupported(DataType<?> dataType) {
        return (dataType.getType() == ObjectPathExpressionHolder.class);
    }

    public List<Class<?>> getSourceTypes() {
        return Arrays.asList(new Class<?> [] {ObjectPathExpressionHolder.class });
    }

    public List<DataType<?>> getSourceDataTypes() {
        return Arrays.asList(new DataType<?> [] {DataTypeFactory.create(ObjectPathExpressionHolder.class)});
    }
    ...
    public DataType<?> getReturnDataType() {
        return DataTypeFactory.create(ObjectPath.class);
    }
        ...
        throws TransformerMessagingException
    {
        ...
        ObjectPathExpressionHolder holder = ((ObjectPathExpressionHolder) src);
        ObjectPath result = new ObjectPath();
        try {
            final String _transformedPath = ((String) evaluateAndTransform(this.muleContext, event, ObjectPathExpressionHolder.class.getDeclaredField("_pathType").getGenericType(), null, holder.getPath()));
