...
/**
 * CopyObjectMessageProcessor invokes the {@link org.mule.modules.documentum.DocumentumConnector#copyObject(com.emc.documentum.fs.datamodel.core.ObjectIdentity, com.emc.documentum.fs.datamodel.core.ObjectIdentity)} method in {@link DocumentumConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    protected Object folderIdentity;
    protected ObjectIdentity _folderIdentityType;
     ...
     */
    public void setFolderIdentity(Object value) {
        this.folderIdentity = value;
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final ObjectIdentity _transformedObjectIdentity = ((ObjectIdentity) evaluateTransformForPayload(getMuleContext(), event, CopyObjectMessageProcessor.class.getDeclaredField("_objectIdentityType").getGenericType(), null, objectIdentity));
            final ObjectIdentity _transformedFolderIdentity = ((ObjectIdentity) evaluateAndTransform(getMuleContext(), event, CopyObjectMessageProcessor.class.getDeclaredField("_folderIdentityType").getGenericType(), null, folderIdentity));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((DocumentumConnector) object).copyObject(_transformedObjectIdentity, _transformedFolderIdentity);
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at DocumentumConnector at copyObject retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
