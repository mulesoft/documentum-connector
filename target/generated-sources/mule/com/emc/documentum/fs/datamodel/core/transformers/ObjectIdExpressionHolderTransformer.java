...
public class ObjectIdExpressionHolderTransformer
    ...
    implements DiscoverableTransformer, MessageTransformer
{
    ...
    public boolean isSourceTypeSupported(Class<?> aClass) {
        return (aClass == ObjectIdExpressionHolder.class);
    }

    public boolean isSourceDataTypeSupported(DataType<?> dataType) {
        return (dataType.getType() == ObjectIdExpressionHolder.class);
    }

    public List<Class<?>> getSourceTypes() {
        return Arrays.asList(new Class<?> [] {ObjectIdExpressionHolder.class });
    }

    public List<DataType<?>> getSourceDataTypes() {
        return Arrays.asList(new DataType<?> [] {DataTypeFactory.create(ObjectIdExpressionHolder.class)});
    }
    ...
    public DataType<?> getReturnDataType() {
        return DataTypeFactory.create(ObjectId.class);
    }
        ...
        throws TransformerMessagingException
    {
        ...
        ObjectIdExpressionHolder holder = ((ObjectIdExpressionHolder) src);
        ObjectId result = new ObjectId();
        try {
            final String _transformedId = ((String) evaluateAndTransform(this.muleContext, event, ObjectIdExpressionHolder.class.getDeclaredField("_idType").getGenericType(), null, holder.getId()));
