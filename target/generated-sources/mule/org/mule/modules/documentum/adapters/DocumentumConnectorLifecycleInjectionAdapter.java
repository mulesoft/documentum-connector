...
/**
 * A <code>DocumentumConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link DocumentumConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.7.2", date = "2015-12-11T05:10:50-03:00", comments = "Build 3.7.x.2633.51164b9")
public class DocumentumConnectorLifecycleInjectionAdapter
    extends DocumentumConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(DocumentumConnectorLifecycleInjectionAdapter.class);
