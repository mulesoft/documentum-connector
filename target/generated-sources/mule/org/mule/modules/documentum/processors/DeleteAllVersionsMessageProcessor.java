...
/**
 * DeleteAllVersionsMessageProcessor invokes the {@link org.mule.modules.documentum.DocumentumConnector#deleteAllVersions(com.emc.documentum.fs.datamodel.core.ObjectIdentity)} method in {@link DocumentumConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.7.2", date = "2015-12-11T05:10:50-03:00", comments = "Build 3.7.x.2633.51164b9")
public class DeleteAllVersionsMessageProcessor
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public DeleteAllVersionsMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final ObjectIdentity _transformedObjIdentity = ((ObjectIdentity) evaluateTransformForPayload(getMuleContext(), event, DeleteAllVersionsMessageProcessor.class.getDeclaredField("_objIdentityType").getGenericType(), null, objIdentity));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((DocumentumConnector) object).deleteAllVersions(_transformedObjIdentity);
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at DocumentumConnector at deleteAllVersions retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
